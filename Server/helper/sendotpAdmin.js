...
const sendOtpA = async (req, res) => {
  try {
    ...
    // Generate OTP inside function for each request
    ...
    adminOtpStorage[email] = {
      otp: otp,
      expires: Date.now() + 15 * 60 * 1000 // 15 minutes from now
    };

    // ✅ Use the same SMTP configuration that works for user OTP
    ...
    const mailOptions = {
      from: `"WorkWave Admin Support" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: "Admin Password Reset - WorkWave",
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            <div class="email-container">
                ...
                <div class="email-body">
                    <p>Dear ${user.name},</p>
                    <p>We received a request to reset your admin password. Please use the OTP below to reset your password:</p>
                ...
                <div class="email-footer">
                    <p>Best regards,<br><strong style="color: #662d91;">WorkWave Admin Team</strong></p>
